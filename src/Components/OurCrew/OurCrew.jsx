...
function OurCrew() {
  ...
  const crew = [
    ...
    { name: 'Miguel Sánchez Rodríguez', text: t('ourCrew.miguelText'), image: '/images/miguel.jpeg', className: 'leftCrew'},
    { name: 'José Luis Remegio', text: t('ourCrew.joseLuisText'), image: '/images/joseLuisCrew.jpeg', className: 'rightCrew'},
  ]
