...
function Services() {
    ...
    const services = [
        ...
        { name: 'marine survey', id: '/marinesurvey', image: '/images/marineSurveyHero.jpg', text:'We will provide you with a detailed, internationally accepted report of the condition and fair market value of your vessel.', className: ''},
